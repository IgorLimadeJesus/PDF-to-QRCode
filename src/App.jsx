...
function HomePage() {
  ...
  return <main className="app-main"><a className="rittech-top" href="https://rittech.com.br/br" target="_blank" rel="noreferrer" aria-label="Visitar Rittech"><img src="/rittech-logo.png" alt="Rittech" /></a><section className="workspace">
    <div className="workspace-heading"><div><span className="eyebrow">GERADOR DE QR CODE</span><h1>Enviar documento</h1><p>Selecione um PDF para gerar um link e QR Code para download.</p></div><span className="format-badge">PDF · até 20 MB</span></div>
